...
class MonumentsControllerTest < ActionController::TestCase
  ...
  test "should create monument" do
    assert_difference('Monument.count') do
      post :create, monument: { category_id: @monument.category_id, description: @monument.description, name: @monument.name }
    end
  ...
  test "should update monument" do
    patch :update, id: @monument, monument: { category_id: @monument.category_id, description: @monument.description, name: @monument.name }
    assert_redirected_to monument_path(assigns(:monument))
  end
